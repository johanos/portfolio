...
In addition to `create-react-app` I have also added the following packages:

-   [React Router](https://reactrouter.com/en/main)
-   [gh-pages](https://github.com/tschaub/gh-pages) - For manual deployment, on push a github action triggers
-   [prettier](https://prettier.io/)
-   [prop-types](https://github.com/facebook/prop-types)

Below is the documentation for `create-react-app` you will find some information on how to perform common tasks.<br>
...
- [Available Scripts](#available-scripts)
  ...
  - [`npm run prettier:fix`](#npm-run-prettierfix)
...
Runs the eslint using the `.eslint.js` configuration

### `npm run lint:fix`

Runs `npm run lint` but fixes anything that can be automatically resolved

### `npm run prettier`

Runs prettier to check files for formatting issues that weren't fixed by the prettier-eslint plugin

### `npm run prettier:fix`

Runs prettier and fixes any auto-fixable issues

### `npm run format`

This should be ran most of the time, it runs `prettier:fix` and `lint:fix` in sequence.

### `npm run predeploy`

Predeploy hook that builds the app, ran by `npm run deploy`

### `npm run deploy`

Uses the `gh-pages` package to deploy the static site manually, this shouldn't be needed often as there's a github action that runs deploy on push to `main`
